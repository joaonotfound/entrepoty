...
class ProductService {
    ...
    fun createProduct(product: CreateProductModel): Either<DomainError, LoadUniqueProductResponse> {
        ...
        return Either.Right(LoadUniqueProductResponse(createdProduct, details.toList()));
    }
